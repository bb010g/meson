...
class ImmutableListProtocol(Protocol[_T1]):
    ...
    @_T.overload
    def __getitem__(self, index: slice, /) -> _T.List[_T1]: ...
    ...
    def __add__(self, other: _T.List[_T1], /) -> _T.List[_T1]: ...

    def __eq__(self, other: _T.Any, /) -> bool: ...
    def __ne__(self, other: _T.Any, /) -> bool: ...
    def __le__(self, other: _T.Any, /) -> bool: ...
    def __lt__(self, other: _T.Any, /) -> bool: ...
    def __gt__(self, other: _T.Any, /) -> bool: ...
    def __ge__(self, other: _T.Any, /) -> bool: ...

    def count(self, item: _T1, /) -> int: ...

    def index(self, item: _T1, /) -> int: ...
...
class ImmutableSetProtocol(Protocol[_T1]):
    ...
    def __and__(self, other: _T.AbstractSet[_T1], /) -> _T.Set[_T1]: ...
    def __or__(self, other: _T.AbstractSet[_T1], /) -> _T.Set[_T1]: ...
    def __sub__(self, other: _T.AbstractSet[_T1], /) -> _T.Set[_T1]: ...
    def __xor__(self, other: _T.AbstractSet[_T1], /) -> _T.Set[_T1]: ...
    ...
    def isdisjoint(self, other: _T.Iterable[_T1], /) -> bool: ...

    def issubset(self, other: _T.Iterable[_T.Any], /) -> bool: ...

    def issuperset(self, other: _T.Iterable[_T.Any], /) -> bool: ...

    def symmetric_difference(self, other: _T.Iterable[_T1], /) -> _T.Set[_T1]: ...
